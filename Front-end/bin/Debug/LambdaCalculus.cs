    ...
    {
      {
        ...
        if (tmp_1 != null)
        {
          var y = tmp_1.P1; var tmp_2 = tmp_0.P2 as _DefinedAs;
          if (tmp_2 != null)
          {
      ...
      }
      {
        ...
        if (tmp_1 != null)
        {
          ...
          if (tmp_2 != null)
          {
            ...
            if (tmp_3 != null)
            {
              var t = tmp_1.P3; var tmp_4 = tmp_0.P2 as _DefinedAs;
              if (tmp_4 != null)
              {
      ...
      }
      {
        ...
        if (tmp_1 != null)
        {
          var t = tmp_1.P1; var u = tmp_1.P2; var tmp_2 = tmp_0.P2 as _DefinedAs;
          if (tmp_2 != null)
          {
            var tmp_3 = tmp_2.P1 as _Dollar;
            if (tmp_3 != null)
