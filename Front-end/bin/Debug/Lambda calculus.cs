...
#line 14 "Content\Lambda calculus\transform.mc"
        if (tmp_1 != null)
        {
          var x = tmp_1.P1; var tmp_2 = tmp_0.P2 as _opDot;
#line 14 "Content\Lambda calculus\transform.mc"
          if (tmp_2 != null)
          {
            var t = tmp_0.P3;
...
#line 30 "Content\Lambda calculus\transform.mc"
        if (tmp_1 != null)
        {
          var y = tmp_1.P1; var tmp_2 = tmp_0.P2 as _Arrow;
#line 30 "Content\Lambda calculus\transform.mc"
          if (tmp_2 != null)
          {
            var tmp_3 = tmp_2.P1 as _Dollar;
#line 30 "Content\Lambda calculus\transform.mc"
            if (tmp_3 != null)
            {
              var x = tmp_3.P1; var u = tmp_2.P2;
#line 30 "Content\Lambda calculus\transform.mc"
              if (x.Equals(y))
              {
#line 30 "Content\Lambda calculus\transform.mc"
...
#line 38 "Content\Lambda calculus\transform.mc"
        if (tmp_1 != null)
        {
          var tmp_2 = tmp_1.P1 as _Dollar;
#line 38 "Content\Lambda calculus\transform.mc"
          if (tmp_2 != null)
          {
            var x = tmp_2.P1; var tmp_3 = tmp_1.P2 as _opDot;
#line 38 "Content\Lambda calculus\transform.mc"
            if (tmp_3 != null)
            {
              var t = tmp_1.P3; var tmp_4 = tmp_0.P2 as _Arrow;
#line 38 "Content\Lambda calculus\transform.mc"
              if (tmp_4 != null)
              {
                var tmp_5 = tmp_4.P1 as _Dollar;
#line 38 "Content\Lambda calculus\transform.mc"
                if (tmp_5 != null)
                {
                  var y = tmp_5.P1; var u = tmp_4.P2;
#line 38 "Content\Lambda calculus\transform.mc"
                  if (x.Equals(y))
                  {
#line 38 "Content\Lambda calculus\transform.mc"
...
#line 42 "Content\Lambda calculus\transform.mc"
                      foreach (var tmp_6 in tmp_7.Run4_())
                      {
                        var t_Prime = tmp_6;
#line 42 "Content\Lambda calculus\transform.mc"
...
#line 47 "Content\Lambda calculus\transform.mc"
        if (tmp_1 != null)
        {
          var t = tmp_1.P1; var u = tmp_1.P2; var tmp_2 = tmp_0.P2 as _Arrow;
#line 47 "Content\Lambda calculus\transform.mc"
          if (tmp_2 != null)
          {
            var tmp_3 = tmp_2.P1 as _Dollar;
...
#line 47 "Content\Lambda calculus\transform.mc"
                foreach (var tmp_4 in tmp_5.Run4_())
                {
                  var t_Prime = tmp_4;
#line 47 "Content\Lambda calculus\transform.mc"
...
#line 20 "Content\Lambda calculus\transform.mc"
            foreach (var tmp_2 in tmp_3.Run())
            {
              var v_Prime = tmp_2;
#line 20 "Content\Lambda calculus\transform.mc"
...
#line 20 "Content\Lambda calculus\transform.mc"
                foreach (var tmp_4 in tmp_5.Run())
                {
                  var res = tmp_4;
#line 20 "Content\Lambda calculus\transform.mc"
                  var result = res;
...
#line 25 "Content\Lambda calculus\transform.mc"
              ...
              {
                var term = new _With(t as Term, new _Arrow(new _Dollar(x as System.String), u as Term));
#line 25 "Content\Lambda calculus\transform.mc"
                var tmp_5 = term;
#line 25 "Content\Lambda calculus\transform.mc"
                foreach (var tmp_4 in tmp_5.Run4_())
